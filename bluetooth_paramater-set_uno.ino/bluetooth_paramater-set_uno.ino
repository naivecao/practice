/*
    bluetooth_paramater-set_uno.ino - a case to set bluetooth paramater of Practice(Program)
    Created by naivecao. Novemeber 22, 2015
    Lasted modified by naivecao. Novemeber 24, 2015
    Co,.Ltd:Lcmj
*/
